...
class TrafficReceiver:
        ...
        try:
            ...
            while self.running:
                try:
                    ...
                    # Send response back
                    response = f"SEC response to packet #{self.stats['udp_packets_received']}"
    ...
    def handle_tcp_client(self, client_socket, addr):
        ...
        try:
            ...
            if data:
                ...
                # Send response back
                response = f"SEC TCP response to connection #{self.stats['tcp_connections']}"
    ...
    def start(self, protocol='both'):
        ...
        print(f"SEC Traffic Receiver starting on port {self.port}")
